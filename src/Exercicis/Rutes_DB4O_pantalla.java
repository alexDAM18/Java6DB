...
public class Rutes_DB4O_pantalla extends JFrame implements ActionListener {
    ...
    JLabel etDistancia = new JLabel("Distancia:");
    JTextField qDistancia = new JTextField(15);
    ...
    private void plenarTaula(ArrayList<PuntGeo> ll_punts){
        ...
        for (int i=0;i<ll_punts.size();i++){
            ...
            ll[i][1]=ll_punts.get(i).getLatidud();
    ...
    private void inicialitzar() throws ClassNotFoundException, SQLException {
    ...
    private void VisRuta(){
    	...
    	Ruta r = llista.get(num_actual);
    	qNom.setText(r.getNom());
    	qDesn.setText("" + r.getDesnivell());
    	qDesnAcum.setText("" + r.getDesnivellAcumulat());
    	plenarTaula(r.getLlistaDePunts());
